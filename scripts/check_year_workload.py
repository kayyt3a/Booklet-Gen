...
and 9 Mathematics) were measured off the page:
    ...
    warm-up / class work / homework / Final Challenge, then total and pages

    Year 1   5 / 52 / 27 / 19, 105 min, 21 pages
    Year 3   5 / 57 / 27 / 18, 110 min, 24 pages
    Year 5   6 / 55 / 29 / 19, 110 min, 22 pages
    Year 7   4 / 57 / 29 / 21, 110 min, 22 pages
    Year 9   4 / 55 / 29 / 18, 105 min, 22 pages
